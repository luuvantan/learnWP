<?php /* Template Name: Food_results */ ?>
...
<?php get_header(); ?>
        ...
        <div class="page-wrapper">
            ...
            <div class="inner-page-hero bg-image" data-image-src="<?php echo get_stylesheet_directory_uri(); ?>/images/profile-banner.jpg">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="restaurant-block">
                                            <div class="left">
                                                <a class="pull-left" href="#"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo1.png" alt="Restaurant logo"> </a>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="restaurant-block">
                                            <div class="left">
                                                <a class="pull-left" href="#"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo2.png" alt="Restaurant logo"> </a>
                                                <div class="pull-left right-text"> <a href="#">Chicken Restaurant</a> <span>68 5th Avenue New York</span> </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="restaurant-block">
                                            <div class="left">
                                                <a class="pull-left" href="#"> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo3.png" alt="Restaurant logo"> </a>
                                                <div class="pull-left right-text"> <a href="#">Chicken Restaurant</a> <span>68 5th Avenue New York</span> </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row text-img-block text-xs-left">
                            <div class="container">
                                <div class="col-xs-12 col-sm-6 right-image text-center hidden-xs-down">
                                    <figure> <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/app.png" alt="Right Image"> </figure>
                                </div>
